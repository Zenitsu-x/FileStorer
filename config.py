...
AUTO_DELETE_MSG = os.environ.get("AUTO_DELETE_MSG", "This file will be automatically deleted in {time}. Please ensure you have saved any necessary content before this time.")
